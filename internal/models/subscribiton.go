...
type Subscription struct {
	...
	StripeCustomerID string           `gorm:"type:varchar(255);not null;default:''" json:"stripe_customer_id"`
	StripePlanID     string           `gorm:"type:varchar(255);not nulldefault:''" json:"stripe_plan_id"`
